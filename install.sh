...
echo "  The first start takes a minute while the AI model loads. If a browser"
echo "  does not open by itself when it is ready, open this address yourself:"
echo ""
echo "      http://localhost:\$PORT"
echo ""
echo "  To stop it, press Ctrl and C together."
echo ""
export HIVE_OPEN_BROWSER=1
